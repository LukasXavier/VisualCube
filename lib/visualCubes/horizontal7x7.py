...
class _7x7(ABCCubeNxN):
    ...
    def __init__(self):
        self.faces = [[color for _ in range(7*7)] for color in NxN.COLORS]

    def move(self, notation: str) -> None:
        # FIX: Almost nothing below can be kept due to the notation for larger cubes
        # NOTES: requires changing control flow, possible factor out initial parsing
